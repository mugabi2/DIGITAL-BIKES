...
//                editor.commit();
    ...
    public void showshare() {
        ...
        esharecode=(EditText)shareDialog.findViewById(R.id.sharecode);
        ...
        Bcontinueshare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!scode.isEmpty()){
                    ...
                    Intent intent = new Intent(registration.this, Mapsimport1.class);
                    intent.putExtra("bikesin", all);
                    startActivity(intent);
                    finish();
                }
