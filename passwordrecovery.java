...
public class passwordrecovery extends AppCompatActivity {
    ...
    String usersurname,userfirstname,userphonenumb,useremailadd,userresidence,usergender;
...
//##################################################################33
    ...
    public  void savingToSharedPrefs( String Ssurname,String Sfirstname,String Sphonenumb,String Semail,String Sresidence,String Sgender){
        ...
        //---saves the values---
        editor.commit();
        Log.d("JSONStatus","saved to prefs successfully"+Ssurname+Sfirstname+Sphonenumb+Sgender);
    }
}
