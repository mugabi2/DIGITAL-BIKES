...
public class confirmRequests extends AppCompatActivity {
    ...
    String usersurname,userfirstname,userphonenumb,useremailadd,userresidence,usercash,userduration,userpaymeth,message;
    Boolean loginStatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            TextView Treq=(TextView)findViewById(R.id.textrequest);
            Treq.append(usersurname+" "+userfirstname+" "+userphonenumb+" "+useremailadd+" "+userresidence+" "+userduration+" "+usercash);
...
//                dialog.show();
        ...
        protected String doInBackground(String... voids) {
            ...
            String connstr="http://192.168.43.113/bikephp/confirm_request.php";
